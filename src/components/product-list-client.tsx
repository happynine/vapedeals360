                ...
                >
                  ...
                  <div className="flex gap-4">
                    <div className="relative h-24 w-24 flex-shrink-0 overflow-hidden rounded-xl bg-gray-100">
                      {(product.image_url || product.home_image_url) && (
                        <SafeImage src={product.image_url || product.image_url_small} alt={t?.name || ""} fill className="object-cover" sizes="96px" />
                      )}
                    </div>
            ...
            return (
              ...
              >
                ...
                >
                  {(product.image_url || product.home_image_url) && (
                    <SafeImage
                      src={product.image_url || product.image_url_small}
                      alt={t?.name || ""}
                      fill
